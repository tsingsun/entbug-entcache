...
func (tx *Tx) init() {
	tx.SecurityJournal = NewSecurityJournalClient(tx.config)
	tx.SecurityPosition = NewSecurityPositionClient(tx.config)
...
// applies a query, for example: SecurityJournal.QueryXXX(), the query will be executed
